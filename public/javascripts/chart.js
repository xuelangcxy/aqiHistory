...
require(
    ...
    function(ec) {
        ...
        var historyChart = ec.init(document.getElementById('chart'));

        function updateAqiHistoryChart() {
            option.title.text = '北京 最近24小时AQI浓度变化趋势';
            $.getJSON('../tmp/aqiHistory.json', function(data) {
                ...
                for (var i = 0; i < 24; i++) {
                    option.series[0].data[23 - i] = info[data.length-i-1].aqi;
                    option.xAxis[0].data[23 - i] = re.exec(info[data.length-i-1].time_point);
        ...
        function updatePm25HistoryChart() {
            option.title.text = '北京 最近24小时PM2.5浓度变化趋势';
            $.getJSON('../tmp/aqiHistory.json', function(data) {
                var info = data;
                var re = /[0-9]+:[0-9]+/;
                ...
                for (var i = 0; i < 24; i++) {
                    option.series[0].data[23 - i] = info[data.length-i-1].pm2_5;
                    option.xAxis[0].data[23 - i] = re.exec(info[data.length-i-1].time_point);
                    historyChart.setOption(option, true);
                };
            })
        ...
        function updatePm10HistoryChart() {
            option.title.text = '北京 最近24小时PM10浓度变化趋势';
            $.getJSON('../tmp/aqiHistory.json', function(data) {
                var info = data;
                var re = /[0-9]+:[0-9]+/;
                ...
                for (var i = 0; i < 24; i++) {
                    option.series[0].data[23 - i] = info[data.length-i-1].pm10;
                    option.xAxis[0].data[23 - i] = re.exec(info[data.length-i-1].time_point);
                    historyChart.setOption(option, true);
                };
            })
        ...
        function updateNo2HistoryChart() {
            option.title.text = '北京 最近24小时NO2浓度变化趋势';
            $.getJSON('../tmp/aqiHistory.json', function(data) {
                var info = data;
                var re = /[0-9]+:[0-9]+/;
                ...
                for (var i = 0; i < 24; i++) {
                    option.series[0].data[23 - i] = info[data.length-i-1].no2;
                    option.xAxis[0].data[23 - i] = re.exec(info[data.length-i-1].time_point);
                    historyChart.setOption(option, true);
                };
            })
        ...
        function updateO3HistoryChart() {
            option.title.text = '北京 最近24小时O3浓度变化趋势';
            $.getJSON('../tmp/aqiHistory.json', function(data) {
                var info = data;
                var re = /[0-9]+:[0-9]+/;
                ...
                for (var i = 0; i < 24; i++) {
                    option.series[0].data[23 - i] = info[data.length-i-1].o3;
                    option.xAxis[0].data[23 - i] = re.exec(info[data.length-i-1].time_point);
                    historyChart.setOption(option, true);
                };
            })
        ...
        function updateSo2HistoryChart() {
            option.title.text = '北京 最近24小时SO2浓度变化趋势';
            $.getJSON('../tmp/aqiHistory.json', function(data) {
                var info = data;
                var re = /[0-9]+:[0-9]+/;
                ...
                for (var i = 0; i < 24; i++) {
                    option.series[0].data[23 - i] = info[data.length-i-1].so2;
                    option.xAxis[0].data[23 - i] = re.exec(info[data.length-i-1].time_point);
                    historyChart.setOption(option, true);
                };
            })
        ...
        function updateCoHistoryChart() {
            option.title.text = '北京 最近24小时CO浓度变化趋势';
            $.getJSON('../tmp/aqiHistory.json', function(data) {
                var info = data;
                var re = /[0-9]+:[0-9]+/;
                ...
                for (var i = 0; i < 24; i++) {
                    option.series[0].data[23 - i] = info[data.length-i-1].co;
                    option.xAxis[0].data[23 - i] = re.exec(info[data.length-i-1].time_point);
                    historyChart.setOption(option, true);
                };
            })
